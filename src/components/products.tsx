...
export default function Products() {
    ...
    return (
        <div className="product-page" id="products">
            ...
            <div className="product-container">
                {
                    images.map((c, i) => (
                        <MotionDiv variants={fromLeft} whileInView='animate' initial='initial' transition={{ delay: 0.3 * i }} className="products-item" key={i}>
            ...
            <MotionDiv variants={fromRight} whileInView='animate' initial='initial' transition={{ ease: 'backInOut' }} className="link-container">
